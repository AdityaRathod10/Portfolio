...
const Computers = ({ isMobile }) => {
  ...
  return (
    <mesh>
      ...
      <primitive
        object={model.scene}
        scale={isMobile ? 0.04 : 0.75} // Adjusted for mobile
        position={isMobile ? [-5.5, -7, -1.5] : [0, -3.25, -1.5]} // Adjusted for mobile
    ...
    >
      <Suspense fallback={<CanvasLoader />}>
        <OrbitControls
          ...
          enablePan={false}
          enableRotate={true}
           target={isMobile ? [-5.5, 1, -1.5] : [0, 0, 0]} // Match target to the model's position
        />
